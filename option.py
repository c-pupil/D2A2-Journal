...
parser.add_argument('--scale', type=int, default=8,##4 | 8 | 16
                    help='scale factor')
parser.add_argument('--dataset', type=str, default='rgbdd',
                    help='dataset nyu, middlebury, lu or rgbdd')  
parser.add_argument('--dataset_dir', type=str, default='/home/zyl/D2A2/load/RGBDD',#Lu | Middlebury | RGBDD
